...
<body>
  <div class="container">
          ...
          <table class="tg">
            ...
            <tbody>
              ...
              <tr>
                <td class="tg-0pky">No Telp</td>
                <td class="tg-0pky">:</td>
                <td class="tg-0pky">(+62) {{ $results->No_Telp }}</td>
              </tr>
            </tbody>
          </table>
        ...
        <table class="tx">
          ...
          <tbody>
            <tr>
              ...
              <td class="tx-pjk6">Rp. {{ number_format($results->Harjul_Barang * $results->QTY) }}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="section">
      <div class="content">
        <p>Yakni <span style="font-weight: bold">{{ $results->Nama_Kategori}}</span> dengan kategori <span style="font-weight: bold">{{ $results->Nama_Jenis }}</span> dengan kode jenis <span style="font-weight: bold">{{ $results->Kode_Jenis }}</span> berjumlah <span style="font-weight: bold">{{ $results->QTY }} LITER</span> dengan HARGA TOTAL <span style="font-weight: bold"><td class="tx-pjk6">Rp. {{ number_format($results->Harjul_Barang * $results->QTY) }}</td>
        </span> secara tunai.</p>
    ...
    <div class="section">
      <div class="signatures">
        <div class="inner-div">
            <h4 style="text-align: center; margin-bottom: 1rem;">Pihak Pertama,</h4>
          ...
          <div class="inner-div">
            <h4 style="text-align: center; margin-bottom: 3rem;">Pihak Kedua,</h4>
